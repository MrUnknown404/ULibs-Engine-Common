...
/** Enum containing all possible key inputs
 * @author -Unknown-
 */
@SuppressWarnings("javadoc")
public enum EnumKeyInput implements IInputEnum {
	...
	private EnumKeyInput(int id, char character) {
		this.character = character;
		this.id = id;
		Inputs.KEY_INPUT_MAP.put(id, this);
	}
	
	private EnumKeyInput(int id) {
		this(id, Character.MIN_VALUE);
	}
